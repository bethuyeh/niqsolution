...
const Contactlearn = () => {
  ...
  return (
      ...
      <div className="container">
          ...
          <div className="follow"><b>Nigeria Address:</b><i className="fa fa-map-marker"></i> Oladipo Diya Street Abuja, Nigeria.</div>
         <div className="follow"><b>UK Address</b> <i className="fa fa-map-marker"></i> +234</div>
